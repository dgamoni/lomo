    ...
    <div id="comments" class="comments-area">
        ...
        <?php if (have_comments()) : ?>
            ...
            <ol class="comment-list">
                ...
                <?php
                     ...
                     */
                    wp_list_comments(array('callback' => 'dahz_comment', 'type' => 'comment', 'avatar_size' => 80));
                ?>
        ...
        <?php
            ...
            $comment_form_args = array(
                ...
                'comment_field'         => '<p class="comment-form-comment"><label class="assistive-text" for="comment">' . __('Comment', 'dahztheme') . '</label><textarea id="comment" placeholder="' . __('Comment', 'dahztheme') . '" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
                ...
                'logged_in_as'          => '<p class="logged-in-as text-small">' . sprintf(__('Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s">%4$s</a>', 'dahztheme'), admin_url('profile.php'), $user_identity, wp_logout_url(apply_filters('the_permalink', get_permalink())), _x('Log out?' ,'dahztheme') ) . '</p>',
        ...
        <?php if (comments_open()) : ?>
            ...
            <div class="form-clear-container">
                ...
                <a href="#" class="clear-comment"><?php _e('Clear', 'dahztheme'); ?></a>
