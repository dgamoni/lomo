...
class Dahz_Widget_Popular_Posts extends WP_Widget {
    ...
    function Dahz_Widget_Popular_Posts() {
        ...
        $this->WP_Widget('dahz-popular-posts', __('DF Widget - Popular Posts', 'dahztheme'), $widget_ops);
                ...
                <?php while ($r->have_posts()) : $r->the_post(); ?>
                    <li class="popularentries">		
                        ...
                        <?php if ($img) : ?>
                            ...
                            <?php else: ?>
                                <img src="<?php echo esc_url( get_template_directory_uri() . '/includes/images/post-formats/standard.jpg' ) ?>" width="60" height="60" alt="default-img">
                            <?php endif; ?>	
