...
class Dahz_Widget_Recent_Posts extends WP_Widget {
    ...
    function Dahz_Widget_Recent_Posts() {
        ...
        $this->WP_Widget('dahz-recent-posts', __('DF Widget - Recent Posts', 'dahztheme'), $widget_ops);
                    ...
                    <li class="recententries">
                        <?php if ($img) : ?>	
                            ...
                            switch ($img_position) {
                                case 'left':
                                    ...
                                    <div class="df-widget-image">
                                        <?php the_post_thumbnail('thumbnail-widget'); ?>
                                    </div>
                                    <?php else: ?>
                                    <div class="df-widget-image">
                                        <img class="widget-img-left" src="<?php echo esc_url( get_template_directory_uri() . '/includes/images/post-formats/standard.jpg' ) ?>" alt="default-img">
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    default:
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo esc_url( get_template_directory_uri() . '/includes/images/post-formats/big/standard.jpg' ) ?>"  alt="default-img">
                                        <?php endif; ?>
                                        <?php
                                        break;
                                }
                            ...
                            <?php if ($show_date) : ?>			
                                ...
                                <span class="post-comments"><a href="<?php echo esc_url(get_comments_link()); ?>"><?php comments_number(__('0 Comments', 'dahztheme'), __('1 Comment', 'dahztheme'), __('% Comments', 'dahztheme')); ?></a></span>
                            <?php endif; ?>

                            <?php if ($img && $img_position == 'left') : ?>	
                            </div>
                        <?php endif; ?>	
                    </li>
                <?php endwhile; ?>
