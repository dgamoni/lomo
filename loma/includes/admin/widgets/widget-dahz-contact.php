...
class Dahz_Widget_Contact extends WP_Widget {
    ...
    function Dahz_Widget_Contact() {
        ...
        $this->WP_Widget('contact', __('DF Widget - Contact Info', 'dahztheme'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        <address>
            ...
            <?php if ($address): ?>
                <span class="address"><p><span class="icon_contact_widget"><i class="fa fa-map-marker "></i></span><span class="p_contact"><?php echo $address; ?></span></p></span>
            <?php endif; ?>

            <?php if ($instance['phone']): ?>
                <span class="phone"><p><span class="icon_contact_widget"><i class="fa fa-phone"></i></span><span class="p_contact"><?php _e('+', 'dahztheme') ?> <?php echo $instance['phone']; ?><span></p></span>
                        <?php endif; ?>

                        <?php if ($instance['fax']): ?>
                            <span class="fax"><p> <span class="icon_contact_widget"><i class="fa fa-file-text-o"></i></span><span class="p_contact"><?php echo $instance['fax']; ?></span></p></span>
                        <?php endif; ?>

                        <?php if ($instance['email']): ?>
                            <span class="email"><p><span class="icon_contact_widget"><i class="fa fa-envelope-o"></i></span><span class="p_contact"><?php _e(' E-Mail', 'dahztheme') ?> : <a href="mailto:<?php echo esc_attr( $instance['email'] ); ?>"><?php echo $instance['email']; ?></a></p></span>
                        <?php endif; ?>

                        <?php if ($instance['web']): ?>
                            <span class="web"><p><span class="icon_contact_widget"><i class="fa fa-globe"></i></span><span class="p_contact"><a href="<?php echo esc_url($instance['web']); ?>"><?php echo $instance['web']; ?></a></span></p></span>
                        <?php endif; ?>
                    ...
                    function form($instance) {
                        ...
                        $defaults = array('title' => __('Contact Info', 'dahztheme'), 'img' => '', 'text' => '', 'address' => '', 'phone' => '', 'fax' => '', 'email' => '', 'web' => '');
