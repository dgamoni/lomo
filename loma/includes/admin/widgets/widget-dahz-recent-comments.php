...
class Dahz_Widget_Recent_Comments extends WP_Widget {
    ...
    function Dahz_Widget_Recent_Comments() {
        ...
        $this->WP_Widget('dahz-recent-comments', __('DF Widget - Recent Comments', 'dahztheme'), $widget_ops);
    ...
    function widget($args, $instance) {
        ...
        $gravatar = !empty($instance['gravatar']) ? $instance['gravatar'] : 60;
