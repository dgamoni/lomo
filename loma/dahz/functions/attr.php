...
/* Loop attributes. */
add_filter( 'dahz_attr_loop-meta',        'dahz_attr_loop_meta',        5 );
add_filter( 'dahz_attr_loop-title',       'dahz_attr_loop_title',       5 );
add_filter( 'dahz_attr_loop-description', 'dahz_attr_loop_description', 5 );
 ...
 * @return void
 */
function dahz_attr( $slug, $context = '' ) {
	echo dahz_get_attr( $slug, $context );
}
 ...
 * @return string
 */
function dahz_get_attr( $slug, $context = '' ) {

	$out    = '';
	$attr   = apply_filters( "dahz_attr_{$slug}", array(), $context );
 ...
 * @return array
 */
function dahz_attr_loop_meta( $attr ) {
 ...
 * @return array
 */
function dahz_attr_loop_title( $attr ) {
 ...
 * @return array
 */
function dahz_attr_loop_description( $attr ) {
