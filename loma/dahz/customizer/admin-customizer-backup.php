...
// =============================================================================
    ...
    ?>
      <div class="wrap">
        ...
        <h2><?php _e('Customizer Backup Import', 'dahztheme'); ?></h2>
        <?php
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <p class="submit">
            <input type="submit" name="submit" id="customizer-submit" class="button" value="<?php _e( 'Upload File and Run Import', 'dahztheme'); ?>" disabled>
          </p>
        </form>
      </div>
    <?php
    ...
    function dahz_customizer_export_option_page() {
      ...
      ?>
        <div class="wrap">
          <div id="icon-tools" class="icon32"><br></div>
          <h2><?php _e('Customizer Backup Export', 'dahztheme'); ?></h2>
          <form method="post">
